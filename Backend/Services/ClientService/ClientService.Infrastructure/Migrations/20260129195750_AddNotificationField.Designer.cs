...
namespace ClientService.Infrastructure.Migrations
{
    ...
    [Migration("20260129195750_AddNotificationField")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClientService.Domain.Entities.FormTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ClientService.Domain.Entities.FormTemplateField", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ClientService.Domain.Entities.FormTemplateFieldOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("template_field_options", (string)null);
                });
            ...
            modelBuilder.Entity("ClientService.Domain.Entities.FormTemplateField", b =>
                {
                    b.HasOne("ClientService.Domain.Entities.FormTemplate", "Template")
                        .WithMany("Fields")
            ...
            modelBuilder.Entity("ClientService.Domain.Entities.FormTemplateFieldOption", b =>
                {
                    b.HasOne("ClientService.Domain.Entities.FormTemplateField", "TemplateField")
                        .WithMany("Options")
